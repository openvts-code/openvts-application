...
/// Role-aware vehicle-history controller.
///
/// Direct port of `SuperadminVehicleHistoryController` that talks to a
/// [LiveMapVehicleService] instead of the role-baked superadmin service.
/// The state model is reused via the [LiveMapVehicleHistoryState] typedef so
/// the existing screen code that reads `state.history` etc. compiles
/// unchanged.
typedef LiveMapVehicleHistoryState = SuperadminVehicleHistoryState;

class LiveMapVehicleHistoryController
    extends StateNotifier<LiveMapVehicleHistoryState> {
  LiveMapVehicleHistoryController(this._service)
